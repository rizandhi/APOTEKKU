...
@section('content')
    ...
    <!--tabel pengeluaran (beliobat)-->
    <div class="modal fade" id="tambahDataModalPengeluaran" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/tambahBeli" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="id_obat">Nama Obat</label>
                            <select class="form-control" id="id_obat" name="id_obat">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header d-flex justify-content-between text-primary">
                        <div class="d-flex justify-content-between">
                            <h6 class="m-0 font-weight-bold w-100">Tabel Pembelian Obat</h6>
                            <div>
                                <a href="#" data-toggle="modal" data-target="#tambahDataModalPengeluaran">
                                    <i class="ml-2 fa-solid fa-square-plus fa-xl"></i>
                                </a>
                            </div>
                        </div>
                        <div>
                            <a href="/laporanpengeluaran" target="_blank"><i class="fa-solid fa-print fa-lg"></i></a>
                        </div>
                    </div>
