...
<body>
    <div class="content">
        <div class="header">
            <h1><strong>Laporan Penjualan</strong></h1>
                ...
                <tbody>
                    @foreach ($totalPenjualan as $item)
                        <tr style="text-align: center">
                            ...
                            <td class="uang no-border-right">{{ number_format($item->total, 0, ',', '.') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="total">
            <p><strong>Total Penjualan: Rp. {{ number_format($totalSeluruhPendapatan, 0, ',', '.') }}</strong></p>
        </div>
